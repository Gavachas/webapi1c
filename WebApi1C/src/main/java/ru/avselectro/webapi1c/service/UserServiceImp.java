...
public class UserServiceImp implements UserService, UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		WebAPIUser user = userRepo.findByUsername(username);
		if (user == null) {
	...
	@Override
	public WebAPIUser saveUser(WebAPIUser user) {
	...
	@Override
	public WebAPIRole saveRole(WebAPIRole role) {
	...
	public void addRoleToUser(String userName, String roleName) {
		...
		WebAPIUser user = userRepo.findByUsername(userName);
		WebAPIRole role = roleRepo.findByName(roleName);
		user.getRoles().add(role);		
	}

	@Override
	public WebAPIUser getUser(String username) {
		log.info("Fetching user {}", username);
		return userRepo.findByUsername(username);
	}

	@Override
	public List<WebAPIUser> getUsers() {
